...
for ite in range(20):
  ...
  file = open('/home/ubuntu/BTP_git/log3big.txt','a')

  model = big_XCEPTION(input_shape, num_classes)
  if ite:
    model.load_weights("/home/ubuntu/BTP_git/weights/test3big/"+"model_%d.h5"%(ite-1))
  ...
  file.write("*****************"+ "\n")
  model.save_weights("/home/ubuntu/BTP_git/weights/test3big/"+"model_%d.h5"%ite)
