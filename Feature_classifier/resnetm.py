...
y_ints = [y.argmax() for y in final_label_train]
class_weight = class_weight.compute_class_weight('balanced', np.unique(y_ints), y_ints)


hist = custom_resnet_model2.fit(imgs_d_train, final_label_train,class_weight = class_weight, batch_size=32, epochs=10, verbose=1, validation_data=(imgs_d_test, final_label_test))
...
file = open('/home/ubuntu/BTP_git3/resnetm.txt','a')
...
file.write("\n\n\n\n\n\n")
file.close()
model.save_weights("/home/ubuntu/BTP_git3/weights/resnetm/model.h5")
